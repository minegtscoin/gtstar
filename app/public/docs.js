...
(function(){
  ...
  var rows = [
    ...
    ["GTS/SUI market", C.ids.market, "object", "The Cetus pool where GTS trades against SUI. Its liquidity is burned: no one can ever withdraw it."],
    ["Liquidity burn proof", A.lpBurn, "object", "Cetus LP Burn proof for the pool's liquidity position. The position no longer exists, so its liquidity stays in the pool for good."],
