...
const config = { network, ids: { package: dep.package, latest: dep.latest || dep.package, token: dep.token || dep.package, board: dep.board, treasury: dep.treasury, pool: dep.pool, market: dep.market, motherlode: dep.motherlodePkg }, accounts: { dev: dep.dev, keeper: dep.keeper, upgradeCap: dep.upgradeCap }, proof: dep.proof || [] };
