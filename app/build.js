...
const config = { network, ids: { package: dep.package, token: dep.token || dep.package, board: dep.board, treasury: dep.treasury, pool: dep.pool, market: dep.market }, accounts: { dev: dep.dev, keeper: dep.keeper, upgradeCap: dep.upgradeCap }, proof: dep.proof || [] };
