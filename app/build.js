...
const config = { network, ids: { package: dep.package, latest: dep.latest || dep.package, token: dep.token || dep.package, board: dep.board, treasury: dep.treasury, pool: dep.pool, market: dep.market, motherlode: dep.motherlodePkg }, accounts: { dev: dep.dev, keeper: dep.keeper, upgradeCap: dep.upgradeCap, timelock: dep.timelock, timelockPkg: dep.timelockPkg, lpBurn: dep.lpBurnProof }, proof: dep.siteProof || dep.proof || [] };
